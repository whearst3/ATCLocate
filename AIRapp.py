...
# lola = [37.791975, -122.446359] <-- home
...
# print time.strftime("%a %b %d %Y - %I:%M:%S %p %Z", time.localtime())
print ("Distance in nm, and direction, from nearest VOR - freq.\n\n")

lola = [32.786393, -117.044352]
refp = findnear(lola[0],lola[1], db)
dnm = refp[1]
ref = refp[0]
name = ref[0]
comment = ref[4]
